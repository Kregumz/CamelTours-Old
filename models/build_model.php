<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
  ...
  class Build_Model extends CI_Model
  {
    ...
    //places stops on the tour
      ...
      $h[] = '          <div class="button-back tooltip"><a href="'.base_url().'catalog/"><img src = "'.base_url().'/media/img/backbtn.png"></img></a><span class="tooltiptext">Back To Catalog</span></div>';
      $h[] = '          <div class="button-download tooltip"><a href="'.base_url().$tour_uri.'dl/"><img src = "'.base_url().'/media/img/downloadbtn.png"></img></a><span class="tooltiptext">Download</span></div>';
      $h[] = '        </div>';
      $h[] = '      </div>';
      $h[] = '    </div>';
